...
variable "redis_subscription_name" {
  description = "Redis Cloud Essentials subscription name. Match your existing subscription to import it."
  type        = string
  default     = "furb-logistics-logistics-service"
}
...
variable "redis_password" {
  description = "Redis Cloud database password. Empty generates a random one; set the existing password to import."
  type        = string
  default     = ""
  sensitive   = true
}
